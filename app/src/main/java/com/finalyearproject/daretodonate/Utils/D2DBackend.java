...
public class D2DBackend {

    private BackendResponseListener backendResponseListener;
    private RequestQueue queue;

    public D2DBackend(Activity activity, BackendResponseListener backendResponseListener) {
        this.backendResponseListener = backendResponseListener;
        this.queue = Volley.newRequestQueue(activity.getApplicationContext());
    }

    public D2DBackend getRequest(String url, JSONObject data, JSONObject header) {

        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.GET, url, data,
    ...
    public D2DBackend postRequest(String url, JSONObject data, JSONObject header) {
    ...
    public D2DBackend putRequest(String url, JSONObject data, JSONObject header) {

        JsonObjectRequest objectRequest = new JsonObjectRequest(Request.Method.PUT, url, data,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        backendResponseListener.backendResponse(false, response);
